///
/// NitroAudioRecorderPlayer-Swift-Cxx-Umbrella.hpp
...
#if __has_include("NitroAudioRecorderPlayer-Swift.h")
// This header is generated by Xcode/Swift on every app build.
// If it cannot be found, make sure the Swift module's name (= podspec name) is actually "NitroAudioRecorderPlayer".
#include "NitroAudioRecorderPlayer-Swift.h"
// Same as above, but used when building with frameworks (`use_frameworks`)
#elif __has_include(<NitroAudioRecorderPlayer/NitroAudioRecorderPlayer-Swift.h>)
#include <NitroAudioRecorderPlayer/NitroAudioRecorderPlayer-Swift.h>
#else
#error NitroAudioRecorderPlayer's autogenerated Swift header cannot be found! Make sure the Swift module's name (= podspec name) is actually "NitroAudioRecorderPlayer", and try building the app first.
#endif
