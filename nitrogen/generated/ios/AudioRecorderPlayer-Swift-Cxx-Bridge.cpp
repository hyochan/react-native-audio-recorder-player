///
/// AudioRecorderPlayer-Swift-Cxx-Bridge.cpp
...
namespace margelo::nitro::audiorecorderplayer::bridge::swift {
  ...
  Func_void_std__string create_Func_void_std__string(void* _Nonnull swiftClosureWrapper) {
    auto swiftClosure = AudioRecorderPlayer::Func_void_std__string::fromUnsafe(swiftClosureWrapper);
  ...
  Func_void_std__exception_ptr create_Func_void_std__exception_ptr(void* _Nonnull swiftClosureWrapper) {
    auto swiftClosure = AudioRecorderPlayer::Func_void_std__exception_ptr::fromUnsafe(swiftClosureWrapper);
  ...
  Func_void_RecordBackType create_Func_void_RecordBackType(void* _Nonnull swiftClosureWrapper) {
    auto swiftClosure = AudioRecorderPlayer::Func_void_RecordBackType::fromUnsafe(swiftClosureWrapper);
  ...
  Func_void_PlayBackType create_Func_void_PlayBackType(void* _Nonnull swiftClosureWrapper) {
    auto swiftClosure = AudioRecorderPlayer::Func_void_PlayBackType::fromUnsafe(swiftClosureWrapper);
  ...
  Func_void_PlaybackEndType create_Func_void_PlaybackEndType(void* _Nonnull swiftClosureWrapper) {
    auto swiftClosure = AudioRecorderPlayer::Func_void_PlaybackEndType::fromUnsafe(swiftClosureWrapper);
  ...
  std::shared_ptr<margelo::nitro::audiorecorderplayer::HybridAudioRecorderPlayerSpec> create_std__shared_ptr_margelo__nitro__audiorecorderplayer__HybridAudioRecorderPlayerSpec_(void* _Nonnull swiftUnsafePointer) {
    AudioRecorderPlayer::HybridAudioRecorderPlayerSpec_cxx swiftPart = AudioRecorderPlayer::HybridAudioRecorderPlayerSpec_cxx::fromUnsafe(swiftUnsafePointer);
  ...
  void* _Nonnull get_std__shared_ptr_margelo__nitro__audiorecorderplayer__HybridAudioRecorderPlayerSpec_(std__shared_ptr_margelo__nitro__audiorecorderplayer__HybridAudioRecorderPlayerSpec_ cppType) {
    ...
    #endif
    AudioRecorderPlayer::HybridAudioRecorderPlayerSpec_cxx& swiftPart = swiftWrapper->getSwiftPart();
